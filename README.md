...
* Download (to your computer) the slides, Pygmy Whitefish R script, Walleye assignments, Pygmy Whitefish and Walleye data files, Reproducible Reports Example document ([available below](#course-materials)). You may want to print the Walleye Assignments document to bring to the workshop.
...
* Please complete [this survey](https://goo.gl/forms/rNZ2lIEZFzkCW6WO2) regarding this short course.
