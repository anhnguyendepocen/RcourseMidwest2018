...
A total of `r ttl` Walleye were captured in `r YEAR`, including `r sex[["female"]]` female, `r sex[["male"]]` male, and `r sex[["unknown"]]` unknown sex individuals. The length distribution was right skewed (`r figs("Histogram",display="cite")`) with a mean length of `r formatC(slen[["mean"]],format="f",digits=1)` inches, `r formatC(rcump[["14"]],format="f",digits=1)`% 14 inches or larger, and `r formatC(rcump[["20"]],format="f",digits=1)`% 20 inches or larger.
